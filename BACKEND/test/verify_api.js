...
async function runTests() {
  ...
  try {
    ...
    const studentDrill = await request('GET', '/api/analysis/student?student_id=12321100062');
    assert(studentDrill.status === 200, 'GET /api/analysis/student returns 200');
    assert(Number(studentDrill.body.data?.student?.regn_numb) === 12321100062, 'Drilldown returns requested student');
    ...
    const inspectRows = [
      {
        ...
        SUBJCODE: 20055,
        SUBJUNCD: 'OBA1101',
        SUBJNAME: 'Professional English & Technical Writing',
        INTNMARK: 26,
        EXT_MARK: 58,
        TOTAL: 84,
        DEGRCODE: 159,
      ...
      },
      {
        ...
        SUBJCODE: 20056,
        SUBJUNCD: 'OBA1102',
        SUBJNAME: 'Matrices, Calculus & Linear Algebra',
        INTNMARK: 22,
        EXT_MARK: 42,
        TOTAL: 64,
        DEGRCODE: 159,
